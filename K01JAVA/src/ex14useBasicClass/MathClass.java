...
/*
Math 클래스
	: 수학관련 메소드를 제공하는 클래스로 모든 메소드가 static으로 선언되어 있따. 객체생성없이 바로 사용이 가능하다.
 */
