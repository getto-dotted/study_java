...
<body onload="document.loginFrm.user_id.focus();">
	...
	<h3>로그인 유지시간 확인하기</h3>
	<fieldset>
		<legend>로그인유지시간</legend>
		<h4><%=session.getMaxInactiveInterval()%>초</h4>
	</fieldset>

	<span style="color: red; font-size: 1.5em;"> 
	<%=request.getAttribute("ERROR_MSG") == null ? "" : request.getAttribute("ERROR_MSG")%></span>
<%
	...
	<form action="LoginProcess.jsp" method="post" name="loginFrm" onsubmit="return loginValidate(this);">
		<table>
			<tr>
				...
				<td rowspan="2"><input type="submit" value="로그인"	style="height: 50px;" tabindex="3" /></td>
			</tr>
			<tr>
				<td>패스워드</td>
