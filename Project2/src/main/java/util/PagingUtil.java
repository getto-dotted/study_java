...
public class PagingUtil {
	...
	public static String pagingImg2(int totalRecordCount, int pageSize, int blockPage, int nowPage, String page) {
		...
		while (blockCount <= blockPage && intTemp <= totalPage) {
			...
			pagingStr += "&nbsp;<button type=\"button\" onclick=\"pNumberFunc("+intTemp+")\" >" + intTemp + "</button>&nbsp;";
