		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">사진게시판</li>
					<li class="breadcrumb-item"><a href="./info">정보게시판</a></li>
									...
									<c:otherwise>
										<c:forEach items="${lists }" var="row" varStatus="loop">
											<tr>
												...
												<img src="${pageContext.request.contextPath}/resources/Upload/${row.nfile }" width="200px"></a></td>
												<td>${row.name }</td>
												<td>${row.pday }</td>
												<td>${row.vcnt }</td>
												<td align="center"><c:if test="${not empty row.ofile }">
												<a href="../pic_Download?ofile=${row.ofile }&nfile=${row.nfile }&idx=${row.idx }">
												<img src="../resources/images/disk.png" width="20" alt="" /></a></c:if></td>
											</tr>
										</c:forEach>
									</c:otherwise>
								</c:choose>
