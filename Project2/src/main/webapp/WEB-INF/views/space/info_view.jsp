	...
	<tr>
		...
		<td colspan="3">
			<c:if test="${not empty row.ofile }">
					${row.ofile }
					<a href="../info_Download?ofile=${row.ofile }&nfile=${row.nfile }&idx=${row.idx}">[다운로드]</a>		
			</c:if>		
		</td>
	</tr>
</tbody>
...
<input type="hidden" name="backURL" value="/space/info"/>
<input type="hidden" name="tname" value="/info/View?idx="/>
