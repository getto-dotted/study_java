	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				<div class="top_title">
					<img src="${pageContext.request.contextPath}/resources/images/space/sub03_title.gif" alt="자유게시판" class="con_title" />
...
<input type="hidden" name="backURL" value="/space/free"/>
<input type="hidden" name="tname" value="/free/View?idx="/>
