	...
	<tr>
		...
		<td colspan="3">
			<c:if test="${not empty row.ofile }">
					${row.ofile }
					<a href="../fam_Download?ofile=${row.ofile }&nfile=${row.nfile }&idx=${row.idx}">[다운로드]</a>		
			</c:if>		
		</td>
	</tr>
</tbody>
...
<input type="hidden" name="backURL" value="/space/fam"/>
<input type="hidden" name="tname" value="/fam/View?idx="/>
<div class="row text-center" style="">
	...
	<button type="button" class="btn btn-warning" 
		onclick="location.href='../space/fam';">리스트보기</button>
</div>
</form> 
</c:forEach>
				</div>
