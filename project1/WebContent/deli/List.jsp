...
<script>
	...
	function deliCheck(e){
		var e = document.getElementsByName("auto");
		var f = document.getElementById("table1");				
		var g = document.getElementById("table2");				
		if(e[0].checked==true){
			...
			<div class="contents_box">
				...
				<div class="right_contents">
										...
										<c:forEach items="${listsbasket }" var="row" varStatus="loop">
											<tr>
												...
												<td><input type="text" name="stock"
													value="${cstock.cstock }" class="n_box" /></td>
												<td><c:choose>
														<c:when test="${not empty row.deliv}">${row.deliv }</c:when>
														<c:otherwise>무료배송</c:otherwise>
													</c:choose></td>
												<td><c:choose>
														<c:when test="${not empty row.dprice}">${row.dprice }</c:when>
														<c:otherwise>0원</c:otherwise>
													</c:choose></td>
												<td style="color: green">${row.price+row.dprice }원</td>
												<td><button type="button" onclick="check()">
														<img src="../images/market/btn01.gif" />
													</button> <br />
					...
					<table cellpadding="0" cellspacing="0" border="0" class="con_table"
						style="width: 100%;" style="margin-bottom:50px;">
						<colgroup>
							<col width="15%" />
							<col width="*" />
						</colgroup>
										...
										<c:forEach items="${listsmember }" var="rowm" varStatus="loop">
											<tr>
												...
												<td style="text-align: left;"><input type="text"
													name="" value="${rowm.name }" class="join_input" /></td>
											</tr>
											<tr>
												<th>주소</th>
												<td style="text-align: left;"><input type="text"
													name="" value="${rowm.zipcode }" class="join_input"
													style="width: 100px; margin-bottom: 5px;" /> <a href=""><img
														src="../images/market/basket_btn03.gif"
														style="margin-bottom: 5px;" /></a><br /> <input type="text"
													name="" value="${rowm.addr }" class="join_input"
													style="width: 300px; margin-bottom: 5px;" /> 기본주소<br /> <input
													type="text" name="" value="${rowm.addr2 }"
													class="join_input" style="width: 300px;" /> 나머지주소</td>
											</tr>
											<c:set var="mobile" value="${fn:split(rowm.mobile, '-') }" />
											<tr>
												<th>휴대폰</th>
												<td style="text-align: left;"><input type="text"
													name="" value="${mobile[0] }" class="join_input"
													style="width: 50px;" /> - <input type="text" name=""
													value="${mobile[1] }" class="join_input"
													style="width: 50px;" /> - <input type="text" name=""
													value="${mobile[2] }" class="join_input"
													style="width: 50px;" /></td>
											</tr>
											...
											<tr>
												<th>이메일주소</th>
												<td style="text-align: left;"><input type="text"
													name="" value="${email[0] }" class="join_input"
													style="width: 100px;" /> @ <input type="text" name=""
													value="${email[1] }" class="join_input"
					...
					<form method="post" name="autoCheck" id="autoCheck">
						예<input type="radio" name="auto" value="true"
							onclick="deliCheck(this)" checked="checked" /> 아니오<input
							type="radio" name="auto" value="false" onclick="deliCheck(this)" />
						</p>
					</form>
					<div id="table1">
						<table cellpadding="0" cellspacing="0" border="0"
							...
							<tbody>
								<tr>
									<form name="member" method="post"></form>
								<tr>
									<th>성명</th>
								...
								<tr>
									...
									<td style="text-align: left;"><input type="text" name=""
										...
										style="width: 50px; margin-bottom: 5px;" /> - <input
										type="text" name="" value="" class="join_input"
										style="width: 50px; margin-bottom: 5px;" /> <a href=""><img
											src="../images/market/basket_btn03.gif"
											style="margin-bottom: 5px;" /></a><br /> <input type="text"
										name="" value="" class="join_input"
										style="width: 300px; margin-bottom: 5px;" /> 기본주소<br /> <input
										type="text" name="" value="" class="join_input"
										style="width: 300px;" /> 나머지주소</td>
								</tr>
								<tr>
									<th>휴대폰</th>
									<td style="text-align: left;"><input type="text" name=""
								...
								<tr>
									<th>배송메세지</th>
									<td style="text-align: left;"><input type="text" name=""
										value="" class="join_input" style="width: 500px;" /></td>
								</tr>
								<tr>
									<th>배송메세지</th>
									<td style="text-align: left;"><input type="text" name=""
								...
								<tr>
									...
									<c:forEach items="${listsmember }" var="rowm" varStatus="loop">
										<tr>
											<th>성명</th>
											<td style="text-align: left;"><input type="text" name=""
												value="${rowm.name }" class="join_input" /></td>
										</tr>
										<tr>
											<th>주소</th>
											<td style="text-align: left;"><input type="text" name=""
												value="${rowm.zipcode }" class="join_input"
												style="width: 100px; margin-bottom: 5px;" /> <a href=""><img
													src="../images/market/basket_btn03.gif"
													style="margin-bottom: 5px;" /></a><br /> <input type="text"
												name="" value="${rowm.addr }" class="join_input"
										...
										<tr>
											<th>휴대폰</th>
											<td style="text-align: left;"><input type="text" name=""
												value="${mobile[0] }" class="join_input"
												style="width: 50px;" /> - <input type="text" name=""
												value="${mobile[1] }" class="join_input"
												style="width: 50px;" /> - <input type="text" name=""
												value="${mobile[2] }" class="join_input"
										...
										<tr>
											<th>이메일주소</th>
											<td style="text-align: left;"><input type="text" name=""
												value="${email[0] }" class="join_input"
												style="width: 100px;" /> @ <input type="text" name=""
												value="${email[1] }" class="join_input"
												style="width: 100px;" /></td>
										</tr>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="con_table"
						style="width: 100%;" style="margin-bottom:30px;">
						<colgroup>
							<col width="15%" />
							<col width="*" />
						</colgroup>
						<tbody>
							<tr>
								<th>결제금액</th>
								<td style="text-align: left;"><span class="money"><c:out value="${ttprice + tdprice}"/>원</span></td>
							</tr>
							<tr>
								<th>결제방식선택</th>
								<td style="text-align: left;"><input type="radio" name="pay"/>
									카드결제&nbsp;&nbsp;&nbsp;<input type="radio" name="pay"/>
									무통장입금&nbsp;&nbsp;&nbsp;<input type="radio" name="pay"/> 실시간 계좌이체</td>
							</tr>
						</tbody>
					</table>
					
					<p style="text-align: right;">
					<a href="../main/main"><img src="../images/market/basket_btn04.gif" /></a>
					</p>
				</div>
			</div>
