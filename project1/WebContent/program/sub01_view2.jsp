...
<div class="row text-center" style="">
	...
	<button type="button" class="btn btn-success" method="post" onclick="location.href='../program/sub01_Iden?idx=${dto.idx }&mode=delete&nowPage=${param.nowPage }';">삭제하기</button>	
