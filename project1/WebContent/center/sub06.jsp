...
<%@ include file="../include/global_head.jsp" %>
 ...
 <body>
    ...
    <div id="map" style="width:700px;height:500px;position:relative;overflow:hidden;"></div> 
				<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=db432e767ea8371037acb99e1e53795b"></script>
					<script>
						var container = document.getElementById('map');
						var options = {
							center: new kakao.maps.LatLng(36.354499, 127.374983),
							level: 3
						};
						...
						// 마커가 표시될 위치입니다 
						var markerPosition  = new kakao.maps.LatLng(36.354499, 127.374983); 
