...
function email_input(){
	...
	var x = document.getElementById("last_email_check2").value;
	 ...
	 if(x == "1"){
		 document.joinForm.email_2.readOnly = false;
		 document.joinForm.email_2.value = "";
		 document.joinForm.email_2.focus();
	 }
	 else{
		 document.joinForm.email_2.readOnly = true;
		 document.joinForm.email_2.value = x;
	 }
 } 
...
<form name="joinForm" onsubmit="return frmCheck()">
			...
			<div class="right_contents">
				...
				<table cellpadding="0" cellspacing="0" border="0" class="join_box">
					...
					<tr>
						...
						<td><input type="text" name="id"  value="" class="join_input" onkeydown="inputIdChk();"/>&nbsp;
						<input type="button" value="               " onclick="openIdChk();" style="background-image: url('../images/btn_idcheck.gif');">    
	...
	<select name="last_email_check2" onChange="email_input();" class="pass" id="last_email_check2" >
		...
		<option value="yahoo.com" >yahoo.com</option>
			...
			&nbsp;&nbsp;<a href="../main/main"><img src="../images/btn02.gif" /></a></p>
