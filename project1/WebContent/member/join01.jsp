...
function agreeCheck(){
	...
	if(f.agreement1.checked != true){
		...
		location.href = '../member/join02.jsp';
...
<form name="agreement" method="post">
				<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" name="agreement1" value="">이용약관과 개인정보취급방침에 동의합니다.</p>
</form>
				<p style="text-align:center; margin-bottom:20px">
				
				<button type="button" onclick="return agreeCheck()"><img src="../images/btn01.gif" /></button>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
