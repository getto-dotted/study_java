...
<div id="top" style="border:0px solid #000;"> 
	<a href="../main/main"><img src="../images/logo.gif" alt="마포구립장애인 직업재활센터" id="top_logo" /></a>
	<ul id="lnb">
		<%
	...
	if (session.getAttribute("USER_ID") == null) {
		...
		<%}else{ %>
		<!-- 로그인후 -->
		<li><a href="../LoginSession/Logout.jsp"><img src="../images/lnb05.gif" alt="LOG OUT" /></a></li>
	...
	<map name="GNB">
		...
		<area shape="rect" alt="" title="" coords="321,0,420,33" href="../prod/List" target="" />
		<area shape="rect" alt="" title="" coords="428,0,529,33" href="../notice/sub01_list2" target="" />
		<area shape="rect" alt="" title="" coords="536,0,638,33" href="../crew/List" target="" />
