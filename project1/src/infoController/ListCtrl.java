...
public class ListCtrl extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String pagingImg = PagingUtil.pagingImg(totalRecordCount, pageSize, blockPage, nowPage, "../info/List?"+addQueryString);
		
		param.put("pagingImg", pagingImg);
		//게시판 리스트 출력을 위한 메소드 호출
		List<InfoDTO> lists = dao.selectListPage(param);
		dao.close();
		...
		//뷰로 포워드
		req.getRequestDispatcher("/info/List.jsp").forward(req, resp);
