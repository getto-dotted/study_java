...
public class ListCtrl extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String pagingImg = PagingUtil.pagingImg(totalRecordCount, pageSize, blockPage, nowPage, "../basket/List?"+addQueryString);
		
		param.put("pagingImg", pagingImg);
		//게시판 리스트 출력을 위한 메소드 호출
		List<BasketDTO> listsbasket = dao.selectListPage(param);
		...
		//뷰로 포워드
		req.getRequestDispatcher("/basket/List.jsp").forward(req, resp);
