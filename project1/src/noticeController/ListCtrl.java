...
public class ListCtrl extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String pagingImg = PagingUtil.pagingImg(totalRecordCount, pageSize, blockPage, nowPage, "../notice/sub01_list2?"+addQueryString);
		...
		//뷰로 포워드
		req.getRequestDispatcher("/notice/sub01_list2.jsp").forward(req, resp);
