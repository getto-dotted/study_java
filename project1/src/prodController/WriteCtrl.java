...
public class WriteCtrl extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/prod/Write.jsp").forward(req, resp);
		}
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(mr != null) {
			...
			try {
				...
				sFileName = nowTime + ofileName.substring(idx, ofileName.length());
				//파일객체 만들기
		...
		if(sucOrFail==1) {
			 ...
			 */
			/*
			req.getRequestDispatcher("/prod/List").forward(req,resp);*/
